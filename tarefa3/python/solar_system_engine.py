...
class SolarSystemEngine(Engine):
  def __init__(self, earth_orbit_trf: Transform, earth_spin_trf: Transform, moon_orbit_trf: Transform, moon_spin_trf: Transform,
               earth_orbit_speed_deg_per_sec=20.0, earth_spin_speed_deg_per_sec=60.0,
               moon_orbit_speed_deg_per_sec=120.0, moon_spin_speed_deg_per_sec=120.0):
